    ...
    >
      <fieldset disabled={readOnly} className="space-y-4">
        ...
        <div className="mt-4 flex gap-6 flex-wrap">
          <div className="text-[12.5px] font-bold text-slate-800">B. Mini-Mental Status Examination (MMSE)</div>
          <div className="text-[12.5px] font-bold text-slate-800">C. Child Adaptive Functioning Assessment Tool</div>
        </div>
      </fieldset>

      <fieldset disabled={readOnly} className="space-y-4">
        <div className="mb-1 text-[12.5px] font-bold text-slate-800">
        ...
        <div className="mt-4 mb-1 text-[12.5px] font-bold text-slate-800">E. Gilliam&rsquo;s Autism Rating Scale-3 (GARS-3)</div>
        <ScoreTable
