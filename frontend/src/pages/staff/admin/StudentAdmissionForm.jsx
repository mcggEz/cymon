    ...
    >
      ...
      <div>
        ...
        <div className="space-y-0.5 mb-4">
          <BlankField label="Login Email Address" hint="Uses Mother/Father email if left blank">
            <input type="email" className={blankInput} value={f.accountEmail} onChange={set('accountEmail')} placeholder="parent@example.com" />
          </BlankField>
          <BlankField label="Login Password" hint="Auto-generated by default (min 6 characters)">
            <input type="text" className={blankInput} value={f.accountPassword} onChange={set('accountPassword')} placeholder="Auto-generated password" />
          </BlankField>
          <BlankField label="Student ID Format" hint="Auto-generated on registration">
            <input className={blankInput} value={`CMPS-${new Date().getFullYear()}-XXX (Auto-Generated on Submission)`} disabled />
          </BlankField>
        </div>
